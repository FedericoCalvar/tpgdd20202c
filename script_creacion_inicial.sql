...
select distinct 
	--Sucursal_id se carga solo !!!
	M.SUCURSAL_DIRECCION, M.SUCURSAL_MAIL, M.SUCURSAL_TELEFONO, M.SUCURSAL_CIUDAD
from gd_esquema.Maestra M
Where M.SUCURSAL_DIRECCION is not null
group by M.SUCURSAL_DIRECCION, M.SUCURSAL_MAIL, M.SUCURSAL_TELEFONO, SUCURSAL_CIUDAD
GO

-- Cliente
insert into FFAN.CLIENTE
select distinct 
	--Cliente_id se carga solo!!!
	M.CLIENTE_APELLIDO, M.CLIENTE_NOMBRE, M.CLIENTE_DIRECCION, M.CLIENTE_DNI,
	M.CLIENTE_FECHA_NAC,M.CLIENTE_MAIL
from gd_esquema.Maestra M
Where M.CLIENTE_APELLIDO is not null
group by M.CLIENTE_APELLIDO, M.CLIENTE_NOMBRE, M.CLIENTE_DIRECCION, M.CLIENTE_DNI,
	M.CLIENTE_FECHA_NAC,M.CLIENTE_MAIL
GO
